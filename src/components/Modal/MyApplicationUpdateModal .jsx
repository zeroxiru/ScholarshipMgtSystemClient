...
const MyApplicationUpdateModal  = ({ isUpdateModalOpen, closeModal, applicationData, onUpdate }) => {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center justify-center">
              ...
              <div className="form-control">
                        ...
                        <select
                            className="select select-bordered"
                            {...register('appliedDegree', { required: 'Degree is required' })}
                        >
                            <option value="">Select...</option>
...
export default MyApplicationUpdateModal ;